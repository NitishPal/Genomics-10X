...
# Get R1 and R2 files
cDNA_seq = input("Enter R1 file of 10X Genomics V1: ")
R1 = gzip.open(cDNA_seq, 'r')

barcode_seq = input("Enter R2 file of 10X Genomics V1: ")
R2 = gzip.open(barcode_seq, 'r')
...
for l1, l2 in zip(R1, R2):
	...
	elif c%4 == 2 and l2 in BarCode_list:
		seq = l2+l1+'\n'
		fastq_row.append(seq)
		# print(seq)
	elif c%4 == 2 and l2 not in BarCode_list:
		fastq_row.append(l2)
	...
	if len(fastq_row) == 4 and len(fastq_row[1]) > 115:
